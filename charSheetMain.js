...
function applyProfessionEffects() {
  ...
  document.getElementById("professionAspectBonuses").innerHTML = `Profession (${
    charProfession[0].toUpperCase() + charProfession.substring(1)
  }):
...
function applyRaceSkillEffects() {
  ...
  if (charRace[3] == "g") {
    document.getElementById(
      "raceAspectBonuses"
    ).innerHTML = `Race (Dragonborn): ${racialAspectBonuses}`;
  } else {
    document.getElementById("raceAspectBonuses").innerHTML = `Race (${
      charRace[0].toUpperCase() + charRace.substring(1)
    }): ${racialAspectBonuses}`;
  }
}
...
function applyRaceEffects() {
  ...
  updateRaceAndSize();
  applyRaceSkillEffects();
}

function assignAspectFavorites() {
  ...
  document.getElementById("humanFavoredAttributes").style = "display: none";
  document.getElementById("humanFavoredAspects").style = "display: none";
  var charRace = document.getElementById("charRace").value;
  ...
  const strMax = document.getElementById("strMax");
  const conMax = document.getElementById("conMax");
  const rlvMax = document.getElementById("rlvMax");
  const perMax = document.getElementById("perMax");
  const intMax = document.getElementById("intMax");
  const wisMax = document.getElementById("wisMax");
  const witMax = document.getElementById("witMax");
  const logMax = document.getElementById("logMax");
  const memMax = document.getElementById("memMax");
  const creMax = document.getElementById("creMax");
  const dexMax = document.getElementById("dexMax");
  const deftMax = document.getElementById("deftMax");

  var strScore = document.getElementById("strScore");
  var conScore = document.getElementById("conScore");
  var rlvScore = document.getElementById("rlvScore");
  var perScore = document.getElementById("perScore");
  var intScore = document.getElementById("intScore");
  var wisScore = document.getElementById("wisScore");
  var witScore = document.getElementById("witScore");
  var logScore = document.getElementById("logScore");
  var memScore = document.getElementById("memScore");
  var creScore = document.getElementById("creScore");
  var dexScore = document.getElementById("dexScore");
  var deftScore = document.getElementById("deftScore");
  ...
  if (charRace == "human") {
    document.getElementById("humanFavoredAttributes").style =
      "display: table-cell";
    document.getElementById("humanFavoredAspects").style =
      "display: table-cell";
  } else if (charRace[3] === "g") {
  ...
  strScore.max = `${parseInt(strMax.innerHTML[1] + strMax.innerHTML[2])}`;
  conScore.max = `${parseInt(conMax.innerHTML[1] + conMax.innerHTML[2])}`;
  rlvScore.max = `${parseInt(rlvMax.innerHTML[1] + rlvMax.innerHTML[2])}`;
  perScore.max = `${parseInt(perMax.innerHTML[1] + perMax.innerHTML[2])}`;
  intScore.max = `${parseInt(intMax.innerHTML[1] + intMax.innerHTML[2])}`;
  wisScore.max = `${parseInt(wisMax.innerHTML[1] + wisMax.innerHTML[2])}`;
  witScore.max = `${parseInt(witMax.innerHTML[1] + witMax.innerHTML[2])}`;
  logScore.max = `${parseInt(logMax.innerHTML[1] + logMax.innerHTML[2])}`;
  memScore.max = `${parseInt(memMax.innerHTML[1] + memMax.innerHTML[2])}`;
  creScore.max = `${parseInt(creMax.innerHTML[1] + creMax.innerHTML[2])}`;
  dexScore.max = `${parseInt(dexMax.innerHTML[1] + dexMax.innerHTML[2])}`;
  deftScore.max = `${parseInt(deftMax.innerHTML[1] + deftMax.innerHTML[2])}`;
...
function applyOnSkillChange() {
  ...
  updateArmorAndDefense();
  addRemovehighlightCyan();
}

function addRemovehighlightCyan() {
  const skillsObject = {
    fasttalkSkill: {
      name: "Fast Talk",
      aspectArray: ["Wit", " Creativity", " Intuition"],
  ...
  for (const skill in skillsObject) {
    document.getElementById(skill).classList.remove("highlightCyan");
    if (skillsObject[skill].value >= 1) {
      document.getElementById(skill).classList.add("highlightCyan");
    }
  }
}

function updateLoad() {
  applyProfessionEffects();
  equipCharacter();
  updateGeneralModifiers();
  applyRaceSkillEffects();
  updateRaceAndSize();
